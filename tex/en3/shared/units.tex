...
% henry
\newcommand{\uHENRY}{\te{H}} % henry

% farad
\newcommand{\uFARAD}{\te{F}} % farad
...
% other
\newcommand{\uNandMsqKGinvsq}{\uN \cdot \uMsq \cdot \uKGinvsq} % newton meter squared per kilogram squared
...
% henry
\newcommand{\ueqHENRY}{$\uHENRY$} % henry

% farad
\newcommand{\ueqFARAD}{$\uFARAD$} % farad
...
% other
\newcommand{\ueqNandMsqKGinvsq}{$\uNandMsqKGinvsq$} % newton meter squared per kilogram squared
