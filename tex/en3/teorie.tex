...
\begin{itemize}
    ...
    \item $u_{\vartheta}$ - měrný součinitel prostupu tepla (\ueqWandMinvsqKinv \fs -- watt na metr čtvereční na kelvin)
    \item $U_{\vartheta}$ - součinitel prostupu tepla (\ueqWandKinv \fs -- watt na metr čtvereční na kelvin)
    \item $r_{\vartheta}$ - měrný tepelný odpor (\ueqMsqKandWinv \fs -- metr čtvereční kelvin na watt)
    \item $R_{\vartheta}$ - tepelný odpor (\ueqKandWinv \fs -- kelvin na watt)
