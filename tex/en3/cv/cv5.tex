...
$$
$$
    - \dot{q} \left[ x \right]_{0}^{d} = \lambda_0 \left[ T \right]_{T_1}^{T_2} + \frac{\lambda_1}{2} \left[ T^2 \right]_{T_1}^{T_2}
$$
$$
...
$$
    \rho \cdot c \cdot v \cdot \frac{dT}{dx} = \dot{Q_V}.
$$

Dále je třeba vyjádřit rychlost $v$ a objemový zdroj tepla $\dot{Q_V}$. Rychlost $v$ je:
$$
...
Objemový zdroj tepla $\dot{Q_V}$ můžeme vyjádřit pomocí intenzity elektrického pole $E$ a proudové hustoty $J$:
$$
    \dot{Q_V} = E \cdot J,
$$
kde:\\
...
Dostaneme tedy:
$$
    \dot{Q_V} = E \cdot \sigma_e \cdot E = \sigma_e \cdot E^2.
$$
...
Dostaneme tedy:
$$
    \dot{Q_V} = \sigma_e \cdot \left( \frac{U}{d} \right)^2.
$$
