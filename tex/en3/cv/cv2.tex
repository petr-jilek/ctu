...
$$
    R_e = \frac{d}{\gamma \cdot S},
$$
kde:\\
$d$ -- délka vodiče (\ueqM),\\
$\gamma$ -- měrná elektrická vodivost (\ueqMinvOHMinv),\\
...
\begin{itemize}
    ...
    \item $\lambda$ -- tepelná vodivost (\ueqWandMinvKinv) $\rightarrow$ $\gamma$ -- měrná elektrická vodivost (\ueqMinvOHMinv),
...
\begin{itemize}
    ...
    \item emisivita $\varepsilon = 0,9$.
\end{itemize}

Destička má stejnou teplotu na obouch stranách (je nekonečně tenká). Sluneční záření má intenzitu $\dot{q} = 1348 \fs \uWandMinvsq$. Stefanova-Boltzmannova konstanta je $\sigma = 5,67 \cdot 10^{-8} \fs \uWandMinvsqKinvq$. Teplota vesmíru je $T_{space} = 3 \fs \uK$.

\subsubsection{Řešení}
Tepelný to $\dot{Q}_{in} \fs (\uW)$, který destička přijme:
$$
    \dot{Q}_{in} = \dot{q} \cdot S \cdot \cos \alpha
$$
...
$$
$$
    \dot{q} \cdot S \cdot \cos \alpha = 2 \cdot S \cdot \varepsilon \cdot \sigma \cdot \left( T^4 - T_{space}^4 \right)
$$
$$
    \dot{q} \cdot \cos \alpha = 2 \cdot \varepsilon \cdot \sigma \cdot \left( T^4 - T_{space}^4 \right)
$$
$$
    \frac{\dot{q} \cdot \cos \alpha}{2 \cdot \varepsilon \cdot \sigma} = T^4 - T_{space}^4
$$
$$
    T^4 = \frac{\dot{q} \cdot \cos \alpha}{2 \cdot \varepsilon \cdot \sigma} + T_{space}^4
$$
$$
    T = \sqrt[4]{\frac{\dot{q} \cdot \cos \alpha}{2 \cdot \varepsilon \cdot \sigma} + T_{space}^4}
$$

Nyní můžeme dosadit a vypočítat:
$$
    T = \sqrt[4]{\frac{1348 \cdot \cos 45^{\circ}}{2 \cdot 0,9 \cdot 5,67 \cdot 10^{-8}} + 3^4} = \sqrt[4]{\frac{1348 \cdot \frac{\sqrt{2}}{2}}{2 \cdot 0,9 \cdot 5,67 \cdot 10^{-8}} + 3^4} =
$$
$$
    \approx 310,87 \fs \uK.
$$
