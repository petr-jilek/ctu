...
$$
    Y_{s,1,2} = j 0.236 + j \frac{0.175}{\sqrt{3}} - j \frac{0.163}{\sqrt{3}} = j 0.236 + j 0.101 - j 0.094 = j 0.243 \fs \uOHMinv
$$
$$
    Y_{s,1,3} = j 0.131 - j \frac{0.394}{\sqrt{3}} + j \frac{0.163}{\sqrt{3}} = j 0.131 - j 0.227 + j 0.094 = -j 0.002 \fs \uOHMinv
$$
$$
    Y_{s,2,3} = -j 0.122 + j \frac{0.394}{\sqrt{3}} - j \frac{0.175}{\sqrt{3}} = -j 0.122 + j 0.227 - j 0.101 = j 0.004 \fs \uOHMinv.
$$
