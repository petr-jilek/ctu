...
\begin{enumerate}[a)]
    ...
    \item Počáteční výška je 0 m nad mořem a gravitační zrychlení je proměnné. Gravitační konstanta je 6,67430 \myFS $10^{-11}$ N \myFS m2 \myFS kg\myFS -2, poloměr Země je 6 371 km a hmotnost Země je 5,97219 \myFS $10^{24}$ kg.
\end{enumerate}
...
\begin{itemize}
    ...
    \item $G$ - gravitační konstanta (N \myFS m2 \myFS kg\myFS -2),
