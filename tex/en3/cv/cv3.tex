...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[thick] (1.5,-0.3) rectangle (2.5,0.3) node[midway] {$R_{\vartheta,\lambda}$};
        \draw[thick] (2.5,0) -- (3.5,0);
        \draw[thick] (3.5,-0.3) rectangle (4.5,0.3) node[midway] {$R_{\vartheta,U}$};
...
\begin{itemize}
    \item tepelný odpor vedení tepla v materiálu válce $R_{\vartheta,\lambda}$,
    \item tepelný odpor přenosu tepla z povrchu válce do okolí $R_{\vartheta,U}$.
\end{itemize}
...
Pro odvození tepelného odporu $R_{\vartheta,\lambda}$ využijeme vztah pro tepelný odpor $R$:
$$
...
Tepelný odpor $dR_{\vartheta,\lambda}$ válce bude tedy:
$$
    dR_{\vartheta,\lambda} = \frac{dr}{\lambda \cdot 2 \pi r \cdot l \cdot dr}.
$$
...
\begin{center}
    \begin{tikzpicture}
        \begin{axis}[
                title = {Závislost tepelného odporu $R_{\vartheta,\Sigma}$ na poloměru válce $r_2$},
                axis lines = middle,
                xlabel = $r_2 \fs (\uM)$,
                ylabel = {$R_{\vartheta,\Sigma} \fs (\uMsqKandWinv)$},
                samples=100,
                domain=0:0.5,
                xmin=0,
                xmax=0.4,
...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw[thick] (2.5,0) -- (3.5,0);
        \draw[thick] (3.5,-0.3) rectangle (4.5,0.3) node[midway] {$R_{U}$};
        \draw[thick] (4.5,0) -- (5,0);
        \draw[thick] (5,0) -- (5,-1);
        \draw[thick] (5.5,-1) -- (4.5,-1) node[midway, below] {$T_2$};
...
\begin{itemize}
    ...
    \item odpor přenosu tepla z povrchu koule do okolí $R_{U}$.
\end{itemize}
...
\begin{center}
    \begin{tikzpicture}
        \begin{axis}[
                title = {Závislost tepelného odporu $R_{\vartheta,\Sigma}$ na poloměru koule $r_2$},
                axis lines = middle,
                xlabel = $r_2 \fs (\uM)$,
                ylabel = {$R_{\vartheta,\Sigma} \fs (\uMsqKandWinv)$},
                samples=100,
